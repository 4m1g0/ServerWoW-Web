	<div id="wiki" class="wiki directory wiki-faction">
		...
		<div class="title">
			...
			<div class="desc">Azeroth es un mundo conflictivo y lleno de guerras, donde estar solo puede ser mortal. Para sobrevivir y prosperar, miembros de todas las razas se reúnen en base a líneas ideológicas y culturales. Cada una de estas facciones es fiel a una filosofía, siendo muy común el desacuerdo entre ellas… de manera violenta. Aun así, a pesar del peligro, la lealtad hacia una facción no pasa desapercibida; aquellos héroes que se arriesguen suelen ser gratamente recompensados. </div>
		</div>
	...
	<span class="clear"><!-- --></span>
			...
			<ul class="navigation">
					<li>
						<a href="javascript:;"
						   id="nav-3"
						   onclick="WikiDirectory.view(this, 3);"
						   class="expansion-3 nav-active">
							Cataclysm
						</a>
					</li>
					<li>
						<a href="javascript:;"
						   id="nav-2"
						   onclick="WikiDirectory.view(this, 2);"
						   class="expansion-2 ">
					...
					<li>
						<a href="javascript:;"
						   id="nav-1"
						   onclick="WikiDirectory.view(this, 1);"
						   class="expansion-1 ">
							The Burning Crusade
						</a>
					</li>
					<li>
						<a href="javascript:;"
						   id="nav-0"
						   onclick="WikiDirectory.view(this, 0);"
						   class="expansion-0 ">
							Clásico
						</a>
					</li>
