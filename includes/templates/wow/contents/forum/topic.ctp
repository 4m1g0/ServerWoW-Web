...
?>
			<div id="post-<?php echo $post['post_id']; ?>" class="post<?php if ($post['blizzpost']) echo ' blizzard'; ?>">
		...
		<div class="forum-actions bottom">
			<div class="actions-panel">
				...
				<ol class="ui-breadcrumb">
					...
					<li>
						<a href="<?php echo $this->getWowUrl('forum/'); ?>" rel="np">
							<?php echo $l->getString('template_menu_forums'); ?>
						</a>
					</li>
					<li>
						<a href="<?php echo $this->getWowUrl('forum/#forum' . $forum->getTopicRootCategoryId()); ?>" rel="np">
							<?php echo $forum->getTopicRootCategoryTitle(); ?>
						</a>
					</li>
					<li>
						<a href="<?php echo $this->getWowUrl('forum/' . $forum->getTopicCategoryId() . '/'); ?>" rel="np">
							<?php echo $forum->getTopicCategoryTitle(); ?>
						</a>
					</li>
					<li class="last">
						<a href="<?php echo $this->getWowUrl('forum/topic/' . $forum->getTopicId()); ?>" rel="np">
							<?php echo $forum->getTopicTitle(); ?>
						</a>
					</li>
				</ol>
				<span class="clear"><!-- --></span>
