<div class="related-content" id="related-<?php echo $tab['type']; ?>">
	<div class="filters inline">
		<div class="keyword">
			<span class="view"></span>
			<span class="reset" style="display: none"></span>
			<input id="filter-name-<?php echo $tab['type']; ?>" type="text" class="input filter-name" data-filter="row" maxlength="25" title="Фильтр" value="Фильтр" />
		</div>
	...
	<div class="table full-width">
		...
		<em><?php if ($cont['subname'] != null) echo $cont['subname']; ?></em>
					...
					<td class="align-center" data-raw="<?php echo $cont['maxlevel']; ?>">
							...
							<?php if ($cont['rank'] == 2) echo '<em>(' . $l->getString('template_boss_boss_rank') . ')</em>'; ?>
							<?php if ($cont['rank'] == 1) echo '<em>(' . $l->getString('template_boss_elite_rank') . ')</em>'; ?>
					</td>
	...
	<span class="clear"><!-- --></span>
        ...
        //<![CDATA[
		Wiki.related['<?php echo $tab['type']; ?>'] = new WikiRelated('<?php echo $tab['type']; ?>', {
			paging: true,
