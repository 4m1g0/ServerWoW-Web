...
<div class="input checkbox">
<input type="checkbox" name="cat[banned_flag_allow_topics]" id="banned_flag_allow_topics" value="1"<?php if ($cat['banned_flag'] & BANNED_FLAG_ALLOW_TOPICS) echo ' checked="checked"'; ?> /> <label for="banned_flag_allow_topics">Allow banned users start new topics</label><br/><br/>
</div>
<div class="input checkbox">
<input type="checkbox" name="cat[banned_flag_allow_posts]" id="banned_flag_allow_posts" value="1"<?php if ($cat['banned_flag'] & BANNED_FLAG_ALLOW_POSTS) echo ' checked="checked"'; ?> /> <label for="banned_flag_allow_posts">Allow banned users answer to created topics</label><br/><br/>
</div>
<div class="input text long">
GM Level Access:
