...
include(SITE_DIR . 'UpdateFields.php');
include(SITE_DIR . 'StoreDefines.php');
...
define('POWER_MASK_RUNIC_POWER', 32);
define('POWER_MASK_RUNE',        64);
...
define('THREAD_FLAG_BLIZZ_ANSWERED', 32);

define('FORUM_TYPE_NONE', 0);
define('FORUM_TYPE_CATEGORY', 1);
define('FORUM_TYPE_TOPIC', 2);
define('FORUM_TYPE_INDEX', 3);
define('FORUM_TYPE_POSTING', 4);
...
define('CHARACTER_LOADING_FLAG_SKIP_ITEMS', 1);
define('CHARACTER_LOADING_FLAG_SKIP_TALENTS', 2);
define('CHARACTER_LOADING_FLAG_SKIP_ACHIEVEMENTS', 4);
define('CHARACTER_LOADING_FLAG_SKIP_FEEDS', 8);
define('CHARACTER_LOADING_FLAG_SKIP_DATA', 16);
define('CHARACTER_LOADING_FLAG_SKIP_GUILD', 32);
define('CHARACTER_LOADING_FLAG_SKIP_RAID_INFO', 64);
define('CHARACTER_LOADING_FLAG_SKIP_SPELLS', 128);

define('ITEM_SOURCE_TYPE_CREATURE', 1);
define('ITEM_SOURCE_TYPE_QUEST', 2);
define('ITEM_SOURCE_TYPE_GAMEOBJECT', 3);
define('ITEM_SOURCE_TYPE_ITEM', 4);
define('ITEM_SOURCE_TYPE_SPELL', 5);
define('ITEM_SOURCE_TYPE_MILLING', 6);
define('ITEM_SOURCE_TYPE_DISENCHANTING', 7);
define('ITEM_SOURCE_TYPE_PICKPOCKETING', 8);
...
define('ADMIN_GROUP_EXTRA_FORUM_COLOR', 16);
define('ADMIN_GROUP_ADD_VIDEO', 32);
define('ADMIN_GROUP_RCV_MSG', 64);
define('ADMIN_GROUP_SEND_MSG', 128);
