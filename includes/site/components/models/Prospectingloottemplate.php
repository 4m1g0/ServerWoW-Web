...
class ProspectingLootTemplate_Model_Component extends Model_Db_Component
{
	public $m_model = 'ProspectingLootTemplate';
	public $m_table = 'prospecting_loot_template';
