...
class PickpocketingLootTemplate_Model_Component extends Model_Db_Component
{
	public $m_model = 'PickpocketingLootTemplate';
	public $m_table = 'pickpocketing_loot_template';
