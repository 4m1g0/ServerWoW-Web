...
var Fansite = {
	...
	sites: {
		...
		judgehype: {
			...
			locales: ['fr'],
			urls: {
				achievement: ['?page=hautsfaits', '?page=hautsfaits&amp;w={0}'],
				faction: ['?page=reputations', '?page=reputations&amp;w={0}'],
				...
				quest: ['?page=quetes', '?page=quetes&amp;w={0}'],
				spell: ['?page=spell', '?page=spell&amp;w={0}'],
				zone: ['?page=zones', '?page=zones&amp;w={0}'],
				item: ['?page=objets', '?page=objets&amp;w={0}'],
				race: ['?page=factions', function(params) {
					return '?page='+ encodeURIComponent(params[1].toLowerCase());
				}],
				npc: ['?page=pnjs', '?page=pnjs&amp;w={0}'],
				pet: ['?page=pnjs-betes', '?page=pnjs-betes&amp;w={0}']
			}
		},
		printwarcraft: {
			name: 'PrintWarcraft',
