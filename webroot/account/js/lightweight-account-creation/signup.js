var WowLanding = {
    ...
    addCinematicIcon: function(promoType) {
    	  ...
    	  var flashPath = "/account/images/"; 	  
    	  
    	  switch (promoType) {
    	  	case "promo-mistert":
    	  		flashPath +=  "lightweight-account-creation/promo-mistert/promo-mistert-icon.swf";
    	  		break;
    	  	default: 
    	  		flashPath +=  "lightweight-account-creation/cinematic-icon.swf";
    	  }
